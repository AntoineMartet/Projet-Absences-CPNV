...
Date de modification : 09.06.2023 par Antoine Martet
Description : Cette page présente toutes les demandes de congé et justificatifs d'absence reçus par le maître de classe.
...
// Pour mise à jour du statut
// Verifier s'il y a $_POST["selectedStatus"] depuis cette page
    ...
    <div>
        ...
        <div id="status-choice">
            <form action="form_validation.php?selectedRowID=<?= @$_GET["selectedRowID"] ?>&selectedRowTypeClass=<?= @$_GET["selectedRowTypeClass"] ?>&statusChanged=yes" method="post">
                ...
                <!--Hidden inputs pour mieux repérer la donnée -->
